...
The public website uses a shared header and footer component from `app.js`. Edit it there when changing the navigation, logo, footer links, or social handles.
